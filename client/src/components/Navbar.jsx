...
const Navbar = () => {
  ...
  const handleSearchSubmit = (e) => {
    e.preventDefault();
    if (searchQuery.trim()) {
      // You can replace this with your search logic or navigation
          ...
          <div className="flex-1 max-w-lg mx-8 hidden lg:block">
            <form onSubmit={handleSearchSubmit} className="relative">
              <input
                ...
                placeholder="Search products, brands and categories"
                className="w-full pl-4 pr-12 py-2 border border-gray-600 text-white placeholder-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-orange-500 focus:border-orange-500"
                style={{ backgroundColor: "#2A2F47" }}
              />
              <button
                type="submit"
                className="absolute inset-y-0 right-0 flex items-center px-4 text-white bg-orange-500 hover:bg-orange-600 rounded-r-md transition-colors"
              >
                Search
              </button>
            </form>
            ...
            {isDropdownOpen && (
              ...
              >
                ...
                <Link
                  ...
                  style={{ "&:hover": { backgroundColor: "#3A4058" } }}
                  onMouseEnter={(e) =>
                    (e.target.style.backgroundColor = "#3A4058")
                  }
                  onMouseLeave={(e) =>
