...
const CustomerDetailsEdit = () => {
  ...
  // State for the address being edited
  ...
  // --- Start of change: Button is now permanently disabled on this page ---

  const isButtonDisabled = true; // Force disable the button on the address edit page

  // Define classes for the deactivated state
  const deactivatedClasses =
    "bg-gray-600 text-gray-400 cursor-not-allowed shadow-none transform-none hover:scale-[1.00] hover:shadow-none";

  // Define the base and conditional classes
  const buttonClasses = `w-full py-4 mt-6 rounded-xl font-extrabold text-lg transition-all duration-200 shadow-xl ${deactivatedClasses}`;
      ...
      <div className="max-w-7xl mx-auto flex flex-col lg:flex-row gap-6 mt-6">
        ...
        <div className="lg:w-1/3">
          <div className="bg-gray-800 p-6 rounded-lg shadow-xl border border-gray-700 sticky top-24">
            ...
            {/* MODIFIED: Button is now permanently disabled and styled as inactive */}
            <button
              className={buttonClasses}
              disabled={isButtonDisabled} // This is now always true
            >
              Place Your Order
            </button>
