...
const CustomerDetailsEdit = () => {
  ...
  return (
    <div className="bg-[#1a2037] min-h-screen p-4 md:p-8 font-sans">
      <header className="flex items-center justify-between p-4 bg-gray-800 border-b border-gray-700 shadow-lg sticky top-0 z-10">
        <div className="text-2xl font-bold text-orange-500">JUMIA</div>
        <div className="text-sm text-gray-400">Edit Customer Address</div>
      </header>
      ...
      <div className="max-w-7xl mx-auto flex flex-col lg:flex-row gap-6 mt-6">
        ...
        <div className="lg:w-1/3">
          <div className="bg-gray-800 p-6 rounded-lg shadow-xl border border-gray-700 sticky top-24">
            ...
            <div className="my-4 p-3 bg-gray-900 text-orange-400 border border-dashed border-gray-700 rounded-md text-sm text-center">
