...
//                 // Modification: Retained w-full md:w-3/4 but REMOVED mx-auto for left alignment
...
//                           onClick={prevItem}
//                           disabled={!canGoPrev}
//                           // Positioning remains relative to the w-3/4 wrapper
...
//               <button
//                 onClick={() => alert("Order Placed! (This is a mock action)")}
//                 disabled={cart.length === 0}
//                 className={`w-full py-4 mt-6 rounded-xl font-extrabold text-lg transition-all duration-200 shadow-xl ${
//                   cart.length > 0
//                     ? "bg-gradient-to-r from-green-500 to-green-600 hover:from-green-600 hover:to-green-700 text-white hover:shadow-green-500/25 transform hover:scale-[1.02]"
